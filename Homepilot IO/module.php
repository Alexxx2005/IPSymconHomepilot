    ...
    */
	...
	private function ValidateConfiguration()
	{
		...
		if ($username == "" || $password == "")
			{
				$this->SetStatus(205); //Felder d�rfen nicht leer sein
			}
		...
		//Import Kategorie f�r HarmonyHub Ger�te
	...
	public function GetState()
	{
		...
		{
			$deviceID = $device->did; //DeviceID des Ger�ts
			$position = $device->position; //Position des Ger�ts
	...
	//Profile zuweisen und Ger�te anlegen
...
################## Datapoints
	...
	protected function GetPostFields($deviceID, $command, $position)
	{
		if($command = 9)
		{
			$commandhomepilot = "cid=9&did=".$deviceID."&goto=".$position."&command=1";
		}
		else
		{
			$commandhomepilot = "cid=9&did=".$deviceID."&command=1";
		}
